package com.PetStoreSystem.Main;


import com.PetStoreSystem.DAO.PetDAO;
import com.PetStoreSystem.Exceptions.*;
import com.PetStoreSystem.Model.*;
            ...
            switch (choice) {
				...
				try {
					...
					System.out.println("Number of vaccinated " + petType + " pets: " + vaccinatedCount);
						...
						System.out.println("No Details available with give pet type and vaccinated status");
					}
